              ...
              children: [
                ...
                Obx(() => controller.getAccountList.isNotEmpty
                    ? DropdownSearch<Datum>(
                        ...
                        validator: (value) {
                          if (value == null) {
                            return 'please choose account name';
                          }
                          return null;
                        },
                        showSearchBox: true,
                ...
                Obx(() => controller.getBankList.isNotEmpty
                    ? DropdownSearch<BankData>(
                        ...
                        validator: (value) {
                          if (value == null) {
                            return 'please choose bank name';
                          }
                          return null;
                        },
                        showSearchBox: true,
                          ...
                          children: [
                            InputFormCurrency(
                                ...
                                ControllerValidator: (value) {
                                  if (value == "Rp. 0" || value == "") {
                                    return 'please type expected amount';
                                  }
                                  return null;
                                }),
                            Text("Expected date",
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                border: Border.all(
                                  color: Colors.grey
                                      .withOpacity(0.1), //color of border
